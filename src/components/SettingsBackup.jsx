        ...
        <div className="p-6 rounded-2xl glass-panel space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white font-semibold text-sm focus:outline-none focus:border-indigo-500 font-medium"
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white font-semibold text-sm focus:outline-none focus:border-indigo-500 mb-2 font-medium"
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white font-bold text-sm focus:outline-none focus:border-indigo-500 tabular-nums"
            />
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white text-sm focus:outline-none focus:border-indigo-500 font-medium cursor-pointer"
            >
              {CURRENCIES.map(c => (
          ...
          <div className="pt-2 border-t border-slate-800/60">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="p-2 rounded-lg bg-slate-950 text-indigo-400 border border-slate-800">
                  <Moon className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-xs font-bold block text-white">Dark Theme</span>
                  <span className="text-[10px] text-slate-400 block">Default</span>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <span className="text-xs font-bold block text-white">Light Theme</span>
                  <span className="text-[10px] text-slate-400 block">Bright & Clean</span>
                </div>
              </button>
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold text-xs shadow-md shadow-indigo-600/25 transition-all cursor-pointer active:scale-98"
          >
        ...
        <div className="p-6 rounded-2xl glass-panel space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white text-sm focus:outline-none focus:border-indigo-500 font-medium"
            />
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900/60 border border-slate-800 text-xs text-slate-400 space-y-1">
            ...
            <span>• If you ignore or dismiss the reminder, Expenso does not record any blank or zero entry.</span>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-slate-200 border border-slate-700/80 font-semibold text-xs transition-colors cursor-pointer active:scale-98"
            >
      ...
      <div className="p-6 rounded-2xl glass-panel space-y-5 border border-slate-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <button
            ...
            className="p-4 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white font-bold text-xs flex flex-col items-center justify-center gap-2 shadow-md shadow-indigo-600/25 transition-all cursor-pointer active:scale-95"
          >
          ...
          <button
            ...
            className="p-4 rounded-xl bg-slate-800/90 hover:bg-slate-800 text-slate-200 border border-slate-700/80 font-bold text-xs flex flex-col items-center justify-center gap-2 transition-all cursor-pointer active:scale-95"
          >
          ...
          <button
            ...
            className="p-4 rounded-xl bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 border border-purple-500/30 font-bold text-xs flex flex-col items-center justify-center gap-2 transition-all cursor-pointer active:scale-95"
          >
          ...
          <button
            ...
            className="p-4 rounded-xl bg-rose-950/30 hover:bg-rose-900/40 text-rose-300 border border-rose-500/30 font-bold text-xs flex flex-col items-center justify-center gap-2 transition-all cursor-pointer active:scale-95"
          >
